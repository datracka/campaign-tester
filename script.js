...
let UNIQUE_CLIENT = "zB3cFUUl7vj9BLybZAOQH";
  ...
  () => {
    try {
      jstag.getid((id) => {
        ...
        console.log(
          `https://takeaction.citizenwindow.io/?uc=${UNIQUE_CLIENT}&uf=${UNIQUE_FORM}&lyticsId=${numericPartOfUid}&utm_term=${utmTerm}&utm_source=${utmSource}&utm_content=${utmContent}&utm_medium=${utmMedium}&first_name=${FIRST_NAME}&last_name=${LAST_NAME}&email=${EMAIL}&phone=${PHONE}`
        );
        ifrm.setAttribute(
          "src",
          `https://takeaction.citizenwindow.io/?uc=${UNIQUE_CLIENT}&uf=${UNIQUE_FORM}&lyticsId=${numericPartOfUid}&utm_term=${utmTerm}&utm_source=${utmSource}&utm_content=${utmContent}&utm_medium=${utmMedium}&first_name=${FIRST_NAME}&last_name=${LAST_NAME}&email=${EMAIL}&phone=${PHONE}`
